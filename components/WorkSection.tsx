        ...
        <section id="work" className="relative w-full bg-[#F3F2ED] pt-2 pb-12 md:py-12">
            <div className="w-[95vw] mx-auto">
                ...
                <div className="relative bg-[#0A0A0A] rounded-3xl p-4 md:p-6 grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 h-auto lg:h-[660px] overflow-hidden">
                    ...
                    <div data-lenis-prevent className="relative z-10 lg:col-span-3 order-2 lg:order-first flex flex-row items-center lg:items-start lg:flex-col gap-4 lg:gap-6 overflow-x-auto lg:overflow-y-auto w-full lg:h-full pb-2 lg:pb-4 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
