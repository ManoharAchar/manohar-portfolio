            ...
            <div className="w-[95vw] mx-auto">
                ...
                <div className="bg-[#E0DFD9] rounded-[25px] pt-6 md:pt-12 lg:pt-16 pb-[25px] flex flex-col text-[#050505] overflow-hidden">
                    <div className="flex flex-col w-full max-w-7xl mx-auto px-4 lg:px-8">
                        {/* Header Group */}
                        <div className="flex flex-col gap-8 mb-16 px-4 lg:px-0">
                        ...
                        {/* Negative X margins stretch the background visually, while inner padding perfectly locks the numbers to the Header text bounds */}
                        <div className="bg-[#F6F4EF] rounded-[20px] py-4 -mx-4 lg:-mx-8 px-4 lg:px-8">
